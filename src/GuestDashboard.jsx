...
import { Camera, MapPin, AlertTriangle, Send, FileText, XCircle, CheckCircle, ArrowLeft, Activity, Clock, Loader2, Search, AlertCircle, Video, X, Circle, StopCircle, LogOut } from 'lucide-react';
...
const GuestDashboard = ({ onBack, onSignOut }) => {
            ...
            <header className="bg-white shadow-sm px-4 py-3 flex justify-between items-center sticky top-0 z-50">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {onSignOut && (
                        <button
                            onClick={onSignOut}
                            className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold px-3 py-2 rounded-lg transition-colors"
                        >
                            <LogOut size={16} />
